...
if __name__ == "__main__":
    try:
      ...
      app.run(ssl_context=('/etc/letsencrypt/archive/games.caramellatte.dev/fullchain4.pem', '/etc/letsencrypt/archive/games.caramellatte.dev/privkey4.pem'), host="0.0.0.0", port=6174)
    except:
