...
seven_days_serv = GameServer("7 days to die", None, [26900,26901,26902], "/home/gameserver/7-days-to-die/", {"file": "/home/gameserver/7-days-to-die/log.txt", "connect": "' joined the game", "disconnect":"' left the game", "splice_start": 46}, {"start": ". startserver.sh -configfile='serverconfig.xml'", "stop" : "ctrl,c"})
pal_server = GameServer("palworld", None, [8211], "/home/gameserver/palworld/", {"file" : None, "connect": None, "disconnect": None, "splice_start": 0}, {"start": ". palserver.sh", "stop": "ctrl,c"})
